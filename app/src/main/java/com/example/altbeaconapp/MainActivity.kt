...
//    private val minor = Identifier.parse("56833")
    ...
    override fun onBeaconServiceConnect() {
        try {
            beaconManager!!.startMonitoringBeaconsInRegion(Region("AltBeaconMini",null,null,null))
        ...
        beaconManager!!.addMonitorNotifier(object: MonitorNotifier{
            ...
            override fun didEnterRegion(region: Region) {
                ...
                Log.d("didEnterRegion",region.toString())
            }
            // 領域外に退出した時に呼ばれる
            override fun didExitRegion(region: Region) {
                // レンジングの停止
                beaconManager!!.stopRangingBeaconsInRegion(region)
                Log.d("didExitRegion",region.toString())
            }
            // 領域への侵入/退出のステータスが変化した時に呼ばれる
            override fun didDetermineStateForRegion(i: Int, region: Region) {
                showToast(region.toString(), Toast.LENGTH_LONG)
                Log.d("didDetermineState" +
                        "",region.toString())
            }
        })
        ...
        beaconManager!!.addRangeNotifier { beacons, region ->
            ...
            beacons
                    ...
                    .forEach { Log.d("addRangeNotifier", it) }
